...
class InitialScreen(QWidget):
        ...
        def __init__(self, parent=None):
            ...
            max_label_size_H = int(screen_width / 16 * 9)
            movie.setScaledSize(QSize(screen_width, max_label_size_H))
...
class CustomTopBar(QWidget):
        ...
        def initUI(self):
            ...
            home_button.setStyleSheet("height: 40px; line-height:40px; background-color:white; color: balck;")
            ...
            self.maximum_button.setIcon(self.maximum_icon)
            self.maximum_button.clicked.connect(self.maximizeWindow)
            ...
            layout.addWidget(self.maximum_button)
        ...
        def maximizeWindow(self):
            if self.parent().isMaximized():
                ...
                self.maximum_button.setIcon(self.restore_icon)
...
class MainWindow(QMainWindow):
        ...
        def initUI(self):
            ...
            self.getGeometry(0, 0, screen_width, screen_height)
            self.setStyleSheet("background-color: black")
